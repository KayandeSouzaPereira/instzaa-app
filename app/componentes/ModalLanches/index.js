...
export default function ModalLanches(){
    ...
    return (
        <View style={{backgroundColor:'rgba(52, 52, 52, 0.7)', flex: 1, justifyContent:'center', alignItems:'center', bottom: 300}}>
            <View style={{width: 380, height: 600, alignContent: "center", justifyContent: "center", alignItems: "center", backgroundColor: theme.colorsPrimary.formBackGround}}>
                <ScrollView style={{width: 360, height: 500, alignContent: "center"}}>
